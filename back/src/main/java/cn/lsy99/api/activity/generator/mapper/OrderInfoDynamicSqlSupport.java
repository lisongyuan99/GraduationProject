...
public final class OrderInfoDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source Table: order_info")
    public static final OrderInfo orderInfo = new OrderInfo();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.id")
    public static final SqlColumn<Integer> id = orderInfo.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.customer_id")
    public static final SqlColumn<Integer> customerId = orderInfo.customerId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.status")
    public static final SqlColumn<Integer> status = orderInfo.status;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.price")
    public static final SqlColumn<Double> price = orderInfo.price;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.create_time")
    public static final SqlColumn<Date> createTime = orderInfo.createTime;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-10T16:16:02.7483878+08:00", comments="Source field: order_info.pay_time")
