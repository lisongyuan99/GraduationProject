...
public final class OrganizerDynamicSqlSupport {
    ...
    public static final SqlColumn<Object> fansId = organizer.fansId;
    ...
    public static final SqlColumn<Object> activitiesId = organizer.activitiesId;
    ...
    public static final class Organizer extends SqlTable {
        ...
        public final SqlColumn<Object> fansId = column("fans_id", JDBCType.ARRAY);

        public final SqlColumn<Object> activitiesId = column("activities_id", JDBCType.ARRAY);
