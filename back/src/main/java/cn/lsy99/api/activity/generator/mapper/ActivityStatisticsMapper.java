...
public interface ActivityStatisticsMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-05T22:09:55.0649135+08:00", comments="Source Table: activity_statistics")
    BasicColumn[] selectList = BasicColumn.columnList(activityId, visits, visitSum);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-05T22:09:55.0639161+08:00", comments="Source Table: activity_statistics")
    ...
    @Results(id="ActivityStatisticsResult", value = {
        ...
        @Result(column="visit_sum", property="visitSum", jdbcType=JdbcType.INTEGER)
    })
    ...
    default int insert(ActivityStatistics record) {
        return MyBatis3Utils.insert(this::insert, record, activityStatistics, c ->
            ...
            .map(visitSum).toProperty("visitSum")
        );
    }
    ...
    default int insertSelective(ActivityStatistics record) {
        return MyBatis3Utils.insert(this::insert, record, activityStatistics, c ->
            ...
            .map(visitSum).toPropertyWhenPresent("visitSum", record::getVisitSum)
        );
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-05T22:09:55.0659107+08:00", comments="Source Table: activity_statistics")
