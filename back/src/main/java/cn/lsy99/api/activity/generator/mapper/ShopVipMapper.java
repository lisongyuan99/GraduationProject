...
public interface ShopVipMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-24T22:40:53.913351+08:00", comments="Source Table: shop_vip")
    ...
    @Options(useGeneratedKeys=true,keyProperty="record.shopId")
    ...
    @Options(useGeneratedKeys=true,keyProperty="records.shopId")
    int insertMultiple(@Param("insertStatement") String insertStatement, @Param("records") List<ShopVip> records);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-24T22:40:53.913351+08:00", comments="Source Table: shop_vip")
    default int insertMultiple(MultiRowInsertStatementProvider<ShopVip> multipleInsertStatement) {
    ...
    default int insert(ShopVip record) {
        return MyBatis3Utils.insert(this::insert, record, shopVip, c ->
            c.map(expireTime).toProperty("expireTime")
        );
    }
    ...
    default int insertSelective(ShopVip record) {
        return MyBatis3Utils.insert(this::insert, record, shopVip, c ->
            c.map(expireTime).toPropertyWhenPresent("expireTime", record::getExpireTime)
        );
    }
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(ShopVip record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(expireTime).equalTo(record::getExpireTime);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-24T22:40:53.913351+08:00", comments="Source Table: shop_vip")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(ShopVip record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(expireTime).equalToWhenPresent(record::getExpireTime);
    }
